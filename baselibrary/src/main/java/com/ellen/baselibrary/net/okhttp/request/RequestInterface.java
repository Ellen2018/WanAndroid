...
public abstract class RequestInterface {
    ...
    protected RequestBuilderExpandInterface requestBuilderExpandInterface;

    public RequestParams getRequestUrlParams() {
        return requestUrlParams;
    }

    public void setRequestUrlParams(RequestParams requestUrlParams) {
        this.requestUrlParams = requestUrlParams;
    }

    public RequestBuilderExpandInterface getRequestBuilderExpandInterface() {
        return requestBuilderExpandInterface;
    }

    public void setRequestBuilderExpandInterface(RequestBuilderExpandInterface requestBuilderExpandInterface) {
    ...
    public interface RequestBuilderExpandInterface{
        void expand(Request.Builder builder);
    }
