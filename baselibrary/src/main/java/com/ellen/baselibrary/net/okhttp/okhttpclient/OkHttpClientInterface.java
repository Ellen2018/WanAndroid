...
public abstract class OkHttpClientInterface {
    ...
    protected OkHttpClientBuilderInterface okHttpClientBuilderInterface;

    public OkHttpClientBuilderInterface getOkHttpClientBuilderInterface() {
        return okHttpClientBuilderInterface;
    }

    public void setOkHttpClientBuilderInterface(OkHttpClientBuilderInterface okHttpClientBuilderInterface) {
        this.okHttpClientBuilderInterface = okHttpClientBuilderInterface;
    }

    protected Context context;

    //在做断点续传的时候设置为false才不会发生 unexpected end of stream
    protected boolean isRetryOnConnectionFailure = true;
    ...
    public interface OkHttpClientBuilderInterface{
        void expand(OkHttpClient.Builder builder);
    }
}
