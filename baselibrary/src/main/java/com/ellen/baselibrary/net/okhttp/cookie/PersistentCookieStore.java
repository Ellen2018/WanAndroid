package com.ellen.baselibrary.net.okhttp.cookie;
 ...
 * AsyncHttpClient#setCookieStore, but can also be used with left_right regular old
...
public class PersistentCookieStore implements CookieStore {
	...
	/**
	 * Construct left_right persistent cookie store.
	 *
	 * @param context
